...
在 `General` 左侧一栏中点击右侧一栏 `Home Directory` 的 `Open Folder` 即可打开家目录。

![](./Config/Config-1-1.png "")

### config.yaml
这是 Clash 的启动文件，位于 Home Directory 中，如果此文件有错，则 Clash 核心将无法启动，一般会出现如下界面：

![](./Config/Config-1-2.png "")
...
## 参考
https://doc.clashforwindows.app/configfile/